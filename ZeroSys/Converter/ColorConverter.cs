...
namespace ZeroSys.Converter
{
   ...
   public class ColorConverter
   {
      ...
      /// <summary>
      /// Convert Color from Hexa to Brush
      /// </summary>
      /// <param name="hexa"></param>
      /// <returns></returns>
      private static Brush t(string hexa)
      {
         var converter = new media.BrushConverter();
         var brush = (Brush)converter.ConvertFromString(hexa);
         return brush;
      }
